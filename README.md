...
| Loja | Estado | Validacao atual |
| --- | --- | --- |
| Amazon | Adapter dedicado | Regressao por dominio + fixtures |
| KaBuM | Adapter dedicado | Regressao por dominio + fixtures |
...
| Outros dominios | Fallback generico | Sem suporte validado por regressao |
...
- `npm run test:ci`: suite rapida oficial de CI
